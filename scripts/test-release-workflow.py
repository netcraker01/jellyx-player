...
require(release, "gh release create \"$release_tag\" --repo \"${GITHUB_REPOSITORY}\" --draft --target \"$BUILT_SHA\"", "release.yml")
...
require(release, "gh release edit \"$release_tag\" --repo \"${GITHUB_REPOSITORY}\" --draft=false", "release.yml")
